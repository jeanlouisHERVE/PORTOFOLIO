      ...
      <div className="wrapper">
        <div className="left">
          ...
          <div className="itemContainer">
            <a href='https://github.com/jeanlouisHERVE' target="_blank" className={`${menuOpen ? "active" : ""}`}><FaGithub style={{ height : '24px', marginRight: '5px', cursor : 'pointer' }}/><span className="itemContent"> jeanlouisHERVE </span></a>
          </div>
          <div className="itemContainer">
